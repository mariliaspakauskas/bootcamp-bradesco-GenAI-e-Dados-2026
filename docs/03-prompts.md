...
### Ajuste 1
Criei meu prompt da forma com que aprendi em outro curso, apesar do Venilton ensinar de um jeito super simples de entender, estou acostumada a estruturar os meus prompts da forma com que coloquei acima. 
Toda vez que preciso de algo mais elaborado estruturo assim. 
Trabalho com marketing, por habito acabo criando uma persona com personalidade, nome, idade, profissão e uma breve história que contextualize o desempenho esperado do agente. Claro que excluí coisas que não interessam para esse agente, se fosse criar um agente para simular um cliente por exemplo eu teria incluido os habitos de consumo na hora de descrever a persona. 

### Ajuste 2 

Reuni tudo numa estrutura só, já que havia a opção de colar diretamente o prompt aproveitei para incluir no final dele tudo que é tipo de exemplos de interação que julguei serem válidos e necessários.
